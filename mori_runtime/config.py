...
_TTS_KEY_MAP = {
    ...
    "zipvoice_zh_prompt_wav": "tts_zipvoice_zh_prompt_wav",
    ...
    "zipvoice_ja_prompt_wav": "tts_zipvoice_ja_prompt_wav",
...
_PATH_DEFAULT_KEYS = {
    ...
    "tts_zipvoice_zh_prompt_wav",
    "tts_zipvoice_ja_prompt_wav",
