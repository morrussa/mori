...
def main() -> int:
    ...
    if bilibili_enabled:
        ...
        # NOTE: mori_live_stream is now LuaJIT-backed (via lupa). Keep Lua runtimes thread-confined:
        # use one poller in main thread for catchup, and create another inside the polling thread.
        poller_boot = BilibiliLivePoller(room_id=room_id)
